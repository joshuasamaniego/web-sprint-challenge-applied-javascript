...
axios
    ...
    .then((res) => {
        ...
        bootstrap.forEach((subData) => {
            ...
            cardsContainer.appendChild(cardMaker(bootstrapName, bootstrapArticleHeadline, bootstrapAuthorImage));
        });
        javascript.forEach((subData) => {
            ...
            cardsContainer.appendChild(cardMaker(javascriptName, javascriptArticleHeadline, javascriptAuthorImage));
        });
        jquery.forEach((subData) => {
            ...
            // console.log(name, headline, authorImage);
            cardsContainer.appendChild(cardMaker(jqueryName, jqueryArticleHeadline, jqueryAuthorImage));
        });
        nodejs.forEach((subData) => {
            ...
            // console.log(name, headline, authorImage);
            cardsContainer.appendChild(cardMaker(nodejsName, nodejsArticleHeadline, nodeAuthorImage));
        });
        technology.forEach((subData) => {
            ...
            // console.log(name, headline, authorImage);
            cardsContainer.appendChild(cardMaker(technologyName, technologyArticleHeadline, technologyAuthorImage));
        });
    })
    .catch((err) => {
